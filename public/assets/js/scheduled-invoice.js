/******** SHow preview****************/
	...
	function showPreview(){
		...
		if(start_date.trim()!=""){
			...
			document.getElementById("s_send_date").innerHTML=jQuery('#start_date').val();
		}
		if(time_periods.trim()!=""){

			document.getElementById("s_send_date").innerHTML='Every '+time_periods+ ' Day';
		}
		var totalInAmount=0;
