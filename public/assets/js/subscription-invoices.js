...
function openTab(cityName, activeTab, nextId, pre) {
    ...
    document.getElementById("next_6").style.display = "none";
    ...
    // document.getElementById("previous_5").style.display = "none";
