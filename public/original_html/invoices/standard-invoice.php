			...
			<div class="page-content-wrapper ">
				...
				<div class="content ">
					...
					<div class="container-fluid container-fixed-lg">
						...
						<h3 class="page-title">Standard Invoice </h3>
					...
					<div class="container-fluid container-fixed-lg">
						<div id="rootwizard" class="m-t-50">
							...
							<ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
								<li class="active">
									<a data-toggle="tab" href="#tab1"> <span><i class="fa fa-user-circle-o" aria-hidden="true"></i> Step 1 - Client Information</span></a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab2"> <span><i class="fa fa-id-card-o" aria-hidden="true"></i> Step 2 - Invoice Details</span></a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab3"> <span><i class="fa fa-list" aria-hidden="true"></i> Step 3 - Invoice Items</span></a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab4"> <span><i class="fa fa-file-text-o" aria-hidden="true"></i> Step 4 - Message & Terms</span></a>
								</li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
								...
								<div class="padding-20 bg-white">
									<ul class="pager wizard">
										<li class="next">
											<button class="btn btn-success btn-cons btn-animated from-left fa fa-arrow-circle-o-right pull-right" type="button">
												<span>Next</span>
											</button>
										</li>
										<li class="next finish hidden">
											<button class="btn btn-success btn-cons btn-animated from-left fa fa-cog pull-right" data-target="#modalSlideLeft" data-toggle="modal" type="button">
															...
															<div class="container-xs-height full-height">
																<div class="row-xs-height">
																	<div class="modal-body col-xs-height col-middle text-center   ">
																		<h5 class="text-primary "><span class="semi-bold">Success!</span> your invoice has been sent to <span class="semi-bold">test@testicle.com</span>. We will notify you when it has been viewed and paid.</h5>
																		<br>
