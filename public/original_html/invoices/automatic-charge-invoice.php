...
<html>
	<head>
		...
		<meta charset="utf-8" />
		<title>Automatic Charge Invoice</title>
				...
				<div class="content ">
					...
					<div class="container-fluid container-fixed-lg">
						<ul class="breadcrumb">
							...
							<li><a href="#" class="active">Automatic Charge Invoice</a>
							</li>
						</ul>

						<h3 class="page-title">Automatic Charge Invoice </h3>
					...
					<div class="container-fluid container-fixed-lg">
						<div id="rootwizard" class="m-t-50">
							...
							<ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm">
								<li class="active">
									<a data-toggle="tab" href="#tab1"> <span><i class="fa fa-calendar" aria-hidden="true"></i> Step 1 - Schedule Charge</span></a>
								</li>
								<li class="">
									...
									<div class="row row-same-height">
										<div class="col-md-5 b-r b-dashed b-grey sm-b-b">
											<div class="padding-30 m-t-50">
												<h2>Automatic Charge Invoices</h2>
										...
										<div class="col-md-7">
											<div class="padding-30">
												...
												<select class="cs-select cs-skin-slide" data-init-plugin="cs-select">
													<option value="sightseeing">Every 7 days from the date they first pay</option>
													<option value="business">Every 14 days from the date they first pay</option>
													<option value="honeymoon">Every 30 days from the date they first pay</option>
												</select>
												<div class="gap"></div>
												<h5>Send <span class="semi-bold">Notification?</span></h5>
												<p>Check the box below if you would like to send an email notification 24 hours prior before we charge their card on your behalf.</p>
