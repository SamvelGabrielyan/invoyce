...
function validateStanFrm(action) {
...
function validateStanFrm2() {
    ...
    openTab('tab3','tab_3','next_5','previous_3');
}
...
function calculateTotal() {
    ...
    for (i = 1; i <= totalInvoice; i++) {
        ...
        //totalInAmount = +totalInAmount + +itemPrice;
...
jQuery(document).ready(function () {
    jQuery('#form-stander').on('submit', function () {
        /***** Paypal method check*******/
