...
<div class="login-wrapper " style="height: 100% !important;">
    ...
    <div class="bg-pic">
        ...
        <img src="{{url('/images/login.jpg')}}" data-src="{{url('/images/login.jpg')}}" data-src-retina="{{url('/images/login.jpg')}}" alt="" class="lazy">
        <!-- END Background Pic-->
    ...
    <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            ...
            <p class="p-t-35 text-center">Log into your Invoyce account below...</p>
            <!-- START Login Form -->
            	{!!Form::open(['url' => route('loginPost'),'method'=>'POST'])!!}
                {!!drawErrors()!!}
                <!-- START Form Control-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="{{route('forgotPassword')}}" class="text-info small">Forgot your password?</a>
                    </div>
                </div>
                <!-- END Form Control-->
                <button class="btn btn-block btn-success btn-cons m-t-10" type="submit">Sign in</button>
            {{ Form::close() }}
            <!--END Login Form-->
