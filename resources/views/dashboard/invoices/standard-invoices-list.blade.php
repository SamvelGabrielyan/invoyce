...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>Manage Standard Invoices | Invoyce</title>
    ...
    <body class="fixed-header menu-pin">
                ...
                <div class="content ">
                    <div class="container-fluid container-fixed-lg">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#" class="active">Standard Invoices</a></li>
                        </ul>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="basicTable">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td class="v-align-middle">
                                                        <div class="btn-group dropdown-default">
                                                            ...
                                                            <ul class="dropdown-menu ">
                                                                ...
                                                                @if($value->save_status !=4 && $value->save_status !=3)
                                                                <li>
                                                                    <a href="#" id="modalPaid_id" data-value="{{$value->id}}" data-target="#modalPaid" data-toggle="modal" >Mark as Paid</a>
                                                                </li>
                                                                @endif
                                                                <!--<li>
                                                                    <a href="#">Cancel</a>
                                                ...
                                                @else
                                                <tr>
                                                    <td colspan="8" style=" text-align: center;">  No standard invoices have been created or sent.  </td>
                                                </tr>
                                                @endif
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="container-xs-height full-height">
                                                <div class="row-xs-height">
                                                    <div class="modal-body col-xs-height col-middle text-center   ">
                                                        ...
                                                        <br>
                                                        <a class="btn btn-default btn-block"  href="{{route('standardInvoicesList')}}">Close</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script src="{{URL::to('/')}}/js/extra/manageStanderList.js?1251"></script>
