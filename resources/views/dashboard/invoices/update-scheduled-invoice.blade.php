                                                    ...
                                                    <div class="panel panel-transparent ">
                                                        ...
                                                        <div class="tab-content" style="padding-left: 0px;">
                                                            <div class="tab-pane active" id="tab-fillup1">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        @if($data['invoice_data']->schedule_type=='1')
                                                                        <input type="text" value="{{$data['invoice_data']->send_invoice_date}}"  name="start_date" id="start_date" class="form-control" />
                                                                        @elseif($data['invoice_data']->invoice_type=='2')
                                                                        <input type="text" value="{{$data['invoice_data']->send_invoice_date}}"  name="start_date" id="start_date" class="form-control" />
                                                                        @else
