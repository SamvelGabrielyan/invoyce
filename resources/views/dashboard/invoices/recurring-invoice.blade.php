    ...
    <body class="fixed-header menu-pin">
        ...
        <div class="page-container ">
            ...
            <div class="page-content-wrapper ">
                <!-- START PAGE CONTENT -->
                <div class="content ">
                    <form role="form" id="form-stander" class="scheduled" action="schedurecSave" method="POST" onSubmit="return validateStanFrm();" autocomplete="off">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" value="0" id="save_status" name="save_status" />
                        <input type="hidden" value="rec" name="invoice_type_code" />
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content-wrapper">
                                                            <div class="modal-content">
                                                                <a  class="close" href="{{route('recurringInvoices')}}"><i class="pg-close fs-14"></i>
                                                                </a>
                                                                        ...
                                                                        <div class="modal-body col-xs-height col-middle text-center   ">
                                                                            <h5 class="text-success "><span class="semi-bold">Success!</span>
                                                                                ...
                                                                                @php $email_id= Session::get('email');@endphp {{$email_id}}</strong>.</span>
                                                                                 {{Session::get('success_msg1')}} We will notify you when it has been viewed and paid.
                                                                            </h5>
                                                                            <br>
                                                                            <a  class="btn btn-default btn-block" href="{{route('recurringInvoices')}}">Close</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
