                        ...
                        <div class="container-fluid container-fixed-lg">
                            ...
                            <div class="padding-0 bg-transparent pull-right">
                                <ul>
                                    ...
                                    <li style="display: inline;">
                                        <a id="show_details" href="javascript:viod();"  data-toggle="modal" data-target="#modalSlideUp" onclick="showPreview();" class="btn btn-link pull-right" > <span><i class="fa fa-search" aria-hidden="true"></i> Preview</span> </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
