...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>Manage Subscription Invoices | Invoyce</title>
...
<li><a href="#" class="active">Subscription Invoices</a>
</li>
</ul>
</div>
...
<tr>
    ...
    <th style="width:1%;text-align: center;">Next Charge</th>
...
<ul class="dropdown-menu ">
  ...
  <li>
  <a href="{{URL::to('/')}}/dashboard/sendReminder/{{$value->id}}/4">Remind</a>
  </li>
  @endif
    <li>
<a href="{{URL::to('/')}}/dashboard/invoices/duplicate/{{$value->id}}">Duplicate</a>
   ...
   @if($value->save_status !=4 && $value->save_status !=3)
    ...
    <li>
        <?php /*?><a href="{{URL::to('/')}}/dashboard/account/cancel_invoice.php?invoiceId={!! base64_encode($value->id) !!}&type=4">Cancel</a><?php */ ?>
        <a href="{{URL::to('/')}}/dashboard/invoices/cancel/{{$value->id}}/4">Cancel</a>
    </li>
    @elseif($value->save_status !=4)
    <li>
        <a href="{{URL::to('/')}}/dashboard/invoices/cancel/{{$value->id}}/4">Cancel</a>
...
@endforeach
@else
<tr><td colspan="8" style=" text-align: center;">  No subscription invoices have been created or sent  </td>  </tr>
@endif
</tbody>
</table>
...
<script src="{{URL::to('/')}}/js/extra/manageSubscriptondList.js?1251"></script>
