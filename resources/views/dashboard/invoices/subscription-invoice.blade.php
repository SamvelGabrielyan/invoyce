...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>Create Subscription Invoice | Invoyce</title>
    ...
    <body class="fixed-header menu-pin">
        ...
        <div class="page-container ">
            ...
            <div class="page-content-wrapper ">
                <!-- START PAGE CONTENT -->
                <div class="content ">
                    <form role="form" id="form-stander" action="{{route('subscriptionInvoiceSave')}}" method="POST" onSubmit="return validateStanFrm();" autocomplete="off">
                        ...
                        <div class="container-fluid container-fixed-lg">
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#" class="active">Subscription Invoice</a>
                                </li>
                            </ul>
                            <div class="padding-0 bg-transparent pull-right">
                                <ul>
                                    ...
                                    <li style="display: inline;">
                                        <a id="show_details" href="javascript:void(0);"  data-toggle="modal" data-target="#modalSlideUp" onclick="showPreview();" class="btn btn-link pull-right" > <span><i class="fa fa-search" aria-hidden="true"></i> Preview</span> </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="padding-30">
                                                    ...
                                                    <div class="checkbox asr___checkbox check-success">
                                                        <input type="checkbox" value="1" id="checkbox1" name='notification_status' >
                                                        <label for="checkbox1">Yes, Send Email Notification <small>(optional)</small></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="padding-30">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-4 col-xs-12 mb___10">
                                            ...
                                            <div class="col-md-7">
                                                <div class="padding-30">
                                                    <div class="form-group">
                                                        ...
                                                        <span id="invoice_message_error" style="color: red; display: none;"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <span id="terms_conditions_error" style="color: red; display: none;"></span>
                                                    </div>
                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="row-xs-height">
                                                                        <div class="modal-body col-xs-height col-middle text-center   ">
                                                                            <h5 class="text-success "><span class="semi-bold">Success!</span>
                                                                                ...
                                                                                <span><strong>@php $email_id = Session::get('email');@endphp  {{$email_id}}</strong>.</span> -->
                                                                ...
                                                                <div class="container-xs-height full-height">
                                                                    <div class="row-xs-height">
                                                                        <div class="modal-body col-xs-height col-middle text-center   ">
                                                                            ...
                                                                            <br>
                                                                            <a  href="{{route('saveAllInvoice')}}" class="btn btn-default btn-block"  >Close</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <script src="{{URL::to('/')}}/js/extra/subscription_invoice.js?12345"></script>
        ...
        <script>
            jQuery(function($){
               $("#next_6 button").click(function(e){                   
                  var paymentmethod_val=$("#paymentmethod") .val();
                  if(paymentmethod_val==""){
                      $("span#paymentmethod_title_error").remove();
                      $("span.select2.select2-container").after('<span id="paymentmethod_title_error" class="error-message" style="">Payment Method is Required!</span>');
                      e.preventDefault();
                      return false;
                  } else{
                      $(".tab-content ul li#next_6").show();
                      $(".tab-content ul li#next_4").hide();
                      return true;
                  }
               }); 
            });
