                ...
                <div class="content ">
                    <div class="container-fluid container-fixed-lg">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#" class="active">Recurring Invoices</a>
                            </li>
                        </ul>
                    </div>
                    <!-- START CONTAINER FLUID -->
                    <div class="container-fluid container-fixed-lg">
                        <form role="form" id="search" name="search" action="recurring-invoices" method="post"  >
                                    ...
                                    <div class="col-xs-8 col-sm-9 col-md-8">
                                        <div class="btn-group m-b-10">
                                            <div class="input-daterange input-group" id="datepicker-range">
                                                <input type="text" class="input-sm form-control" name="start" required id="start_date" placeholder="Start Date"/>
                                                <span class="input-group-addon">to</span>
                                                <input type="text" class="input-sm form-control" name="end" id="end_date"  placeholder="End Date" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-3 col-md-4"> <button type="submit" class="btn btn-success btn-block btn-cons m-r-15" style="height: 32px;">FILTER</button></div>
                                </div>
                            </div>
                        </form>
                                        ...
                                        <table class="table table-hover" id="basicTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:2%;text-align: center;">Paid By</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($data['allinvoice'] as $key => $value)
                                                <tr>
                                                    ...
                                                    <td class="v-align-middle">
                                                        <div class="btn-group dropdown-default">
                                                            ...
                                                            <ul class="dropdown-menu ">
                                                                ...
                                                                <li>
                                                                    <a href="{{URL::to('/')}}/dashboard/sendReminder/{{$value->id}}/2">Remind</a>
                                                                </li>
                                                                @endif
                                                                <!--<li>
                                                                    <a href="#">Duplicate</a>
                                                                    </li>-->
                                                                @if($value->invoice_type==2 && ($value->save_status!=2 && $value->save_status!=3))
                                                                <li>
                                                                    <a href="{{URL::to('/')}}/dashboard/invoices/update-recurring-invoice/{{$value->id}}">Edit</a>
                                                                </li>
                                                                @endif
                                                                ...
                                                                @if($value->invoice_type==3 && $value->save_status==3)
                                                                <li>
                                                                    <a href="{{URL::to('/')}}/dashboard/account/cancel_invoice.php?invoiceId= {!!base64_encode($value->id)!!}&type=2">Cancel</a>
                                                                </li>
                                                                @elseif ($value->save_status<3 )
                                                                <li>
                                                                    <a href="{{URL::to('/')}}/dashboard/invoices/cancel/{{$value->id}}/2">Cancel</a>
                                                                </li>
                                                                @endif
                                                                <!--<li>
                                                                    <a href="#">Cancel</a>
                        ...
                        <div class="pgn-wrapper" data-position="top-right" id="bouncyFlip">
                            <div class="pgn push-on-sidebar-open pgn-flip">
                                <div class="alert alert-success">
                                    ...
                                    <span>Reminder has been sent successfully.</span>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="pgn-wrapper" data-position="top-right" id="bouncyFlip">
                            <div class="pgn push-on-sidebar-open pgn-flip">
                                <div class="alert alert-success">
                                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                                    <span>Invoice has been cancel.</span>
                                </div>
                            </div>
                        </div>
                        @endif
