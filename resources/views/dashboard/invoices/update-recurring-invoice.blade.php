...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>Edit Scheduled Invoice | Invoyce</title>
    ...
    <body class="fixed-header menu-pin">
        ...
        <div class="page-container ">
            ...
            <div class="page-content-wrapper ">
                <!-- START PAGE CONTENT -->
                <div class="content ">
                    <form role="form" id="form-stander" action="scheduledUpdate" method="POST" onSubmit="return validateStanFrm();" autocomplete="off">
                        ...
                        <div class="container-fluid container-fixed-lg">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#" class="active">Edit Scheduled Invoice</a>
                                </li>
                            </ul>
                                                ...
                                                <div class="padding-30">
                                                    <div class="panel panel-transparent ">
                                                        ...
                                                        <ul class="nav nav-tabs nav-tabs-fillup" data-init-reponsive-tabs="dropdownfx" style="border-bottom: 0px">
                                                            <li class="active">
                                                                <a data-toggle="tab" href="#tab-fillup2"><span>Recurring Invoices</span></a>
                                                            </li>
                                                        </ul>
                                                        <!-- @if($data['invoice_data']->send_invoice_date!='1970-01-01' && $data['invoice_data']->send_invoice_date!='0000-00-00' && $data['invoice_data']->send_invoice_date!='N/A' && $data['invoice_data']->send_invoice_date!=''){
                                                            }
                                                            @else{
                                                                $date='';
                                                            } @endif; -->
                                                        ...
                                                        <div class="tab-content" style="padding-left: 0px;">
                                                            <div class="tab-pane active" id="tab-fillup2">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-7">
                                                <div class="padding-30">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"  placeholder="Separate with a comma ie. test@test.com, test2@test.com" type="text" value="{{$data['invoice_data']->additional_email}}" id="additional_email" name="additional_email">
                                                    </div>
                                                    <hr>
                                                    <div class="form-group">
                                    ...
                                    <div class="padding-20 bg-white">
                                        <ul class="pager wizard">
                                            <li  id="next_2" style="display: none;">
                                                <button onclick="validateStanFrmRecurring();" class="btn btn-success btn-cons btn-animated   pull-right" type="button">
                                                    <span>Next </span>
                                                </button>
                                            </li>
                                                                    ...
                                                                    <div class="row-xs-height">
                                                                        <div class="modal-body col-xs-height col-middle text-center   ">
                                                                            <h5 class="text-success "><span class="semi-bold">Success!</span>
                                                                                ...
                                                                                @if($data['invoice_data']->additional_email!='') {{$data['invoice_data']->additional_email}}
                                                                                @endif;
                                                                                </span>
                                            ...
                                            <li class="next"  style="display: {{$data['status']}};" id="errordiv3">
                                                <div class="modal fade slide-right in fadeInRightBig animated"  id="modalSlideLeft" tabindex="-1" role="dialog" aria-hidden="true" style="display: {{$data['status']}};">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content-wrapper">
                                                            <div class="modal-content">
                                                                <a href="{{url('')}}/dashboard/invoices/invoices" class="close" ><i class="pg-close fs-14"></i>
                                                                </a>
                                                                <div class="container-xs-height full-height">
                                                                    <div class="row-xs-height">
                                                                        <div class="modal-body col-xs-height col-middle text-center   ">
