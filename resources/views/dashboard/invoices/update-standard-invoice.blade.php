...
<head>
    ...
    <meta charset="utf-8" />
    <title>Edit a Standard Invoice | Invoyce</title>
...
<!-- END HEADER -->
    ...
    <div class="page-content-wrapper ">
        <!-- START PAGE CONTENT -->
        <div class="content ">
            <form role="form" id="form-stander" action="saveStandardInvoice" method="POST" onSubmit="return validateStanFrm();" autocomplete="off">
                ...
                <div class="container-fluid container-fixed-lg">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#" class="active">Edit Standard Invoice</a>
                        </li>
                    </ul>
                    <div class="padding-0 bg-transparent pull-right">
                        <ul>
                            ...
                            <li style="display: inline;">
                                ...
                                <a href="javascript:void(0);"  data-toggle="modal" data-target="#modalSlideUp" onclick="showPreview();" class="btn btn-link pull-right" > <span><i class="fa fa-search" aria-hidden="true"></i> Preview</span> </a>
                            </li>
                        </ul>
                    </div>
                </div>
                                                ...
                                                @if($i==1)
                                                    <div class="{{ $i == 1 ?'input_fields_wrap' : '' }}">
                                                        ...
                                                        <div >
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control"  placeholder="Description (optional)" type="text" name="item_description_{{$i}}" id="item_description_{{$i}}" value="{{$value->description}}">
                                                            ...
                                                            <div class="col-md-3 form-group" style="padding-left:0px;">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control input-group-lg full_input"  placeholder="Rate" onblur="calculateTotal();" onkeypress="return isNumberKey(event);" type="text" name="item_rate_{{$i}}" id="item_rate_{{$i}}" value="{{$value->rate}}">
                                                                </div>
                                                            ...
                                                            <div class="col-md-2 form-group">
                                                                <div class="radio m-0">
                                                                    <label class="p-0">
                                                                        <input type="radio" name="item_dis_{{$i}}" id="item_dis_{{$i}}" onclick="calculateTotal();" value="yes" {{ 'yes' == $value->discount_type ? 'checked="checked"' : '' }}>
                                                                        <span class="cr"><i class="cr-icon fa fa-circle"></i></span>$ Discount</label>
                                                                </div>
                                                                <div class="radio m-0">
                                                                    <label class="p-0">
                                                                        <input type="radio" name="item_dis_{{$i}}" id="item_dis_{{$i}}" onclick="calculateTotal();" value="no"  {{ 'no' == $value->discount_type ? 'checked="checked"' : '' }}>
                                                                        <span class="cr"><i class="cr-icon fa fa-circle"></i></span>% Discount</label>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="padding-30">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="checkupdate" value="yes" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="padding-20 bg-white">
                                <ul class="pager wizard">
                                    ...
                                    <li class="" id="next_5" style="display: none;">
                                        <button class="btn btn-success btn-cons btn-animated from-left pull-right" type="submit">
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content-wrapper">
                                                        <div class="modal-content">
                                                            <a  class="close"  href="{{url('')}}/dashboard/invoices/standard-invoices-list"><i class="pg-close fs-14"></i>
                                                            </a>
                                                            <div class="container-xs-height full-height">
                                                                <div class="row-xs-height">
                                                                    <div class="modal-body col-xs-height col-middle text-center   ">
                                                                        <h5 class="text-success "><span class="semi-bold">Success!</span> your invoice has been sent to
                                                                            <span>{{$data['invoice_data']->email}}@if($data['invoice_data']->additional_email!=''), {{$data['invoice_data']->additional_email}}@endif</span>. We will notify you when it has been viewed and paid.
                                                                        </h5>
                                                                        <br>
                                                                        <a  href="{{url('')}}/dashboard/invoices/standard-invoices-list" class="btn btn-default btn-block"  >Close</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <li class="next"  style="display: {{$data['status']}};" id="errordiv2">
                                            <div class="modal fade slide-right in fadeInRightBig animated"  id="modalSlideLeft" tabindex="-1" role="dialog" aria-hidden="true" style="display: {{$data['status']}};">
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content-wrapper">
                                                        <div class="modal-content">
                                                            <a  class="close" href="{{url('')}}/dashboard/invoices/saved-invoices"><i class="pg-close fs-14"></i>
                                                            </a>
                                                            <div class="container-xs-height full-height">
                                                                <div class="row-xs-height">
                                                                    <div class="modal-body col-xs-height col-middle text-center   ">
                                                                        <h5 class="text-success "><span class="semi-bold">Success!</span> your invoice has been saved as draft.</h5>
                                                                        <br>
                        ...
                        <div class="invoice padding-30 sm-padding-10">
                            ...
                            <!-- <img alt="" class="" width="200" data-src-retina="" data-src="{{url('')}}/profile/1516233097.png" src="{{url('')}}/profile/1516233097.png">-->
                                ...
                                <address class="m-t-10">
                                    <strong>{{Auth::user()->company}}</strong> @if(Auth::user()->company)<br>@endif
                                    {{Auth::user()->address}} @if(Auth::user()->address)<br>@endif
                                    {{Auth::user()->city}}, {{Auth::user()->state}} {{Auth::user()->zip_code}}
                                    @if(Auth::user()->phone)<br>@endif
                                    {{Auth::user()->phone}}
                                    @if(Auth::user()->email)<br>@endif
                                    {{Auth::user()->email}}
                                </address>
                            </div>
