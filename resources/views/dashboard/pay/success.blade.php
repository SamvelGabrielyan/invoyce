...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>Invoice Paid | Invoyce</title>
                            ...
                            <div class="panel-body">
                                <div class="invoice padding-50 sm-padding-10">
                                    <div class="col-md-8 col-md-offset-2 col-xs-6 text-center">
                                        <div class=" sm-m-t-20">
                                            <h2 class="font-montserrat all-caps hint-text">Thank You for Your Payment!</h2>
                                            <h5>You will receive a receipt in your email in just a few minutes. If you have any questions please contact your vendor below or you can contact support at <a href="mailto:help@invoyce.me">help@invoyce.me.</a></h5>
                                            <br>
                                            <address class="m-t-10">
                                                {{$profile_info->company}} <br>
                                                {{$profile_info->address}}<br>
                                                {{$profile_info->city}}, {{$profile_info->state}} {{$profile_info->zip_code}}<br><br>
                                                @if($profile_info->phone!=''){{$profile_info->phone}}@endif<br>
                                                {{$profile_info->email}}
                                            </address>
                                        </div>
