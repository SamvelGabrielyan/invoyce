...
<!-- END HEADER -->
<!-- BEGIN JUMBOTRON -->
<section class="demo-hero-5" data-pages="parallax" data-pages-bg-image="assets/images/gallery_hero_1.jpg">
    <div class="container-xs-height full-height">
        <div class="col-xs-height col-middle text-center">
            <h1 class="text-white inner">Privacy Policy</h1>
        </div>
    </div>
</section>
<section class="p-b-40 p-t-40">
    <div class="container">
        <div class="row">
            <div class="sm-p-l-20">
                <p>We understand that your privacy is important to you, that&rsquo;s why we had our legal team write this ridiculously long explanation for how we are legally bound to keeping your personal information where it belongs to yourself.</p>
                <p>This statement governs our privacy policies with respect to those users of the Site ("Visitors") who visit without transacting business and Visitors who register to transact business on the Site and make use of the various services offered by www.Invoyce.me (collectively, "Services") ("Authorized Customers").</p>
                ...
                <p><strong>With whom may the information be shared?</strong></p>
                ...
                <p>Personally Identifiable Information collected by Invoyce is securely stored and is not accessible to third parties or employees of Invoyce except for use as indicated above.</p>
                <p><strong>What choices are available to Visitors regarding collection, use and distribution of the information?</strong></p>
                <p>Visitors and Authorized Customers may opt out of receiving unsolicited information from or being contacted by us and/or our vendors and affiliated agencies by responding to emails as instructed, or by contacting us at: help@invoyce.me</p>
                ...
                <p><strong>How does Invoyce use login information?</strong></p>
                <p>Invoyce uses login information, including, but not limited to, IP addresses, ISPs, and browser types, to analyze trends, administer the Site, track a user's movement and use, and gather broad demographic information.</p>
                ...
                <p>Invoyce has entered into and will continue to enter into partnerships and other affiliations with a number of vendors. Such vendors may have access to certain Personally Identifiable Information on a need to know basis for evaluating Authorized Customers for service eligibility. Our privacy policy does not cover their collection or use of this information. Disclosure of Personally Identifiable Information to comply with law. We will disclose Personally Identifiable Information in order to comply with a court order or subpoena or a request from a law enforcement agency to release information. We will also disclose Personally Identifiable Information when reasonably necessary to protect the safety of our Visitors and Authorized Customers.</p>
                ...
                <p>Visitors and Authorized Customers may contact us to update Personally Identifiable Information about them or to correct any inaccuracies by emailing us at help@invoyce.me.</p>
                <p><strong>Can a Visitor delete or deactivate Personally Identifiable Information collected by the Site?</strong></p>
                <p>We provide Visitors and Authorized Customers with a mechanism to delete/deactivate Personally Identifiable Information from the Site's database by contacting help@invoyce.me. However, because of backups and records of deletions, it may be impossible to delete a Visitor's entry without retaining some residual information. An individual who requests to have Personally Identifiable Information deactivated will have this information functionally deleted, and we will not sell, transfer, or use Personally Identifiable Information relating to that individual in any way moving forward.</p>
                ...
                <p>Any notice required to be given to Invoyce under or related to these Terms must be in writing, addressed as follows:</p>
                <p>Invoyce LLC</p>
                <p>2121 6th Avenue N616
                <br>
                    Seattle, WA 98121
                </p>
