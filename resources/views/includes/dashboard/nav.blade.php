	...
	<div class="sidebar-menu">
		...
		<ul class="menu-items">
			...
			<li class="{{ Request::is('dashboard/invoices/choose') ? 'active2' : '' }}">
				<a href="{{route('invoices')}}"><span class="title">Create New Invoice</span></a>
			...
			<li class="
				...
				<ul class="sub-menu">
					...
					<li class="
						...
						<a href="{{route('standardInvoicesList')}}">Manage Standard</a>
					...
					<li class="
						...
						<a href="{{route('scheduledInvoicesList')}}">Manage Scheduled</a>
					...
					<li class="
						...
						<a href="{{route('subscriptionInvoicesList')}}">Manage Subscriptions</a>

						<span class="icon-thumbnail">sb</span>
					</li>

					<li class="
							   {{ Request::is('dashboard/invoices/recurring-invoices') ? 'active2' : '' }}">
						<a href="{{route('recurringInvoices')}}">Manage Recurring</a>

						<span class="icon-thumbnail">rc</span>
					</li>

					<li class="{{ Request::is('dashboard/invoices/saved-invoices') ? 'active2' : '' }}">
						<a href="{{route('saveAllInvoice')}}">Saved Invoices</a>
			...
			<li class="{{ Request::is('dashboard/reports/reports') ? 'active2' : '' }}">
				<a href="{{route('reports')}}"><span class="title">Reports</span></a>
			...
			<li class="
					   ...
					   {{ Request::is('dashboard/billing' ) ? 'open active' : '' }}
				...
				<ul class="sub-menu">
					...
					<li class="{{ Request::is('dashboard/billing') ? 'active2' : '' }}">
			...
			<li class="">
				...
				<ul class="sub-menu">
					<li class="">
						<a href="{{route('paymentGateway')}}">Payment Processors</a>
