                ...
                <tr>
                    <td valign="top" class="hr-bot" style="font-family: Helvetica, Arial, Sans-Serif; border-bottom-width: 1px; border-bottom-color: #F1F3F4; border-bottom-style: solid;">
                        <table width="100%" style="-premailer-border: 0; -premailer-cellpadding: 0; -premailer-cellspacing: 0; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border: none;" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="h1 h1-light-padding" align="center" style="font-family: 'Montserrat', sans-serif; color: #1EB343; font-size: 28px; line-height: 36px; font-weight: bold; padding: 18px 55px;text-transform:uppercase;">Just a Reminder that Your Invoice #{{$data['invoice_data']->invoice_number}} is Now Due</td>
                            </tr>
                            <tr>
                                <td class="copy" style="font-family: Helvetica, Arial, Sans-Serif; font-size: 16px; line-height: 28px; color: #828282; padding-bottom: 25px; font-weight: 300; padding-left: 150px; padding-right: 0px;">
                                    ...
                                    Hi {{$data['invoice_data']->company_name}},
                                    <br> This is a reminder that your invoice from {{$data['profile_info']->company}} is now due.<br/>
                                    Amount due:  ${{$data['invoice_data']->total_amount}}.
                                    @else
                                    ...
                                    <table class="btn btnRounded" style="min-width: 150px; -premailer-border: 0; -premailer-cellpadding: 0; -premailer-cellspacing: 0; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 215px; border: none;"
                                        ...
                                        <tr>
                                            <td class="btnTxtCell" height="50" bgcolor="#2DBE60" valign="middle" style="min-width: 150px; line-height: 8px; text-align: center; white-space: nowrap; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; font-family: Helvetica, Arial, Sans-Serif;"
                                                align="center">
                                                <!--[if mso]>&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--><a href="<?=url('')?>/pay/{{$data['invoice_data']->invoice_url}}" target="_blank"  style="color: #ffffff; display: block; font-size: 16px; font-weight: bold; line-height: 22px; letter-spacing: 1px; max-width: 420px; min-width: 90px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 20px;">View and Pay</a>
                                                <!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;<![endif]-->
                                            </td>
                                        </tr>
                                    </table>
