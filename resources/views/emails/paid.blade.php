...
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
			...
			<link href="<?=url('')?>/dashboard/emails/fonts/GothamSSm-Book.otf" rel="stylesheet">
			<link href="<?=url('')?>/dashboard/emails/fonts/caecilialtstd-light-webfont.eot" rel="stylesheet">
			<link href="<?=url('')?>/dashboard/emails/fonts/caecilialtstd-light-webfont.woff" rel="stylesheet">
...
-ms-interpolation-mode: bicubic !important;
			...
			<style type="text/css">
				...
				@font-face {
					...
					src: url('emails/fonts/caecilialtstd-light-webfont.eot'), url('emails/fonts/caecilialtstd-light-webfont.woff'), url('emails/fonts/caecilialtstd-light-webfont.eot');
				}
				@font-face {
					font-family: "GothamSSm-Book";
					src: url('emails/fonts/GothamSSm-Book.otf');
				}
				@font-face {
		...
		<body id="default" style="width: 100%; -webkit-appearance: none; -webkit-font-smoothing: antialiased; font-smooth: always; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; text-size-adjust: 100%; margin: 0; padding: 0;">
			<!-- start of #background -->
							...
							<tr>
								<td valign="top" class="hr-bot" style="font-family: Helvetica, Arial, Sans-Serif; border-bottom-width: 1px; border-bottom-color: #F1F3F4; border-bottom-style: solid;">
									<table width="100%" style="-premailer-border: 0; -premailer-cellpadding: 0; -premailer-cellspacing: 0; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border: none;" cellpadding="0" cellspacing="0">
										<tr>
											<td class="h1 h1-light-padding" align="center" style="font-family: 'Montserrat', sans-serif; color: #1EB343; font-size: 28px; line-height: 36px; font-weight: bold; padding: 18px 55px;text-transform:uppercase;">Invoice Paid</td>
										</tr>
										<tr>
											<td class="copy" style="font-family: Helvetica, Arial, Sans-Serif; font-size: 16px; line-height: 28px; color: #828282; padding-bottom: 25px; font-weight: 300; padding-left: 55px; padding-right: 55px;">
												Hi {{$profile_info->fname}},
												<br> The invoice you sent to <strong>{{$invoice_data->company_name}}</strong> has been paid! The funds will be deposited into your bank account shortly. Feel free to contact us if you have any questions.</td>
										</tr>
