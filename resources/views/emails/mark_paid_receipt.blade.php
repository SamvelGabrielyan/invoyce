...
<!-- saved from url=(0065)http://invoice.taggartmediagroup.com/dashboard/emails/receipt.php -->
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>
		Invoice #{{$invoice_data->invoice_number}} Receipt
	</title>
	...
	<link href="{{URL::to('/')}}/dashboard/emails/fonts/GothamSSm-Book.otf" rel="stylesheet">
	<link href="{{URL::to('/')}}/dashboard/emails/fonts/caecilialtstd-light-webfont.eot" rel="stylesheet">
	<link href="{{URL::to('/')}}/dashboard/emails/fonts/caecilialtstd-light-webfont.woff" rel="stylesheet">
...
-ms-interpolation-mode: bicubic !important;
	...
	<style type="text/css">
		@font-face {
			...
			src: url('{{URL::to('/')}}/dashboard/emails/fonts/caecilialtstd-light-webfont.eot'), url('{{URL::to('/')}}/dashboard/emails/fonts/caecilialtstd-light-webfont.woff'), url('{{URL::to('/')}}/dashboard/emails/fonts/caecilialtstd-light-webfont.eot');
		}
		@font-face {
			font-family: "GothamSSm-Book";
			src: url('{{URL::to('/')}}/dashboard/emails/fonts/GothamSSm-Book.otf');
		}
		@font-face {
			font-family: 'Montserrat', sans-serif;
			src: url('https://fonts.googleapis.com/css?family=Montserrat:200,400,700');
		}
		...
		@media only screen and (max-width: 480px) {
			...
			.download-module table .txt {
				padding-right: 50px !important;
				padding-left: 50px !important;
				line-height: 24px !important;
			}
			.download-module table .icons .platforms {
				width: 210px !important;
				margin: 0 auto;
			}
			.social-module .social-module-cell {
				padding: 27px 50px 43px 50px !important;
			}
			.social-module .social-module-cell .txt-table {
				width: 100% !important;
			}
			.social-module .social-module-cell .txt-table .text {
				padding-right: 0px !important;
				padding-bottom: 18px !important;
				font-size: 16px !important;
				text-align: center !important;
			}
			.social-module .social-module-cell .icon-table {
				width: 1% !important;
				float: none !important;
				margin: 0 auto !important;
			}
			.social-module .social-module-cell .icon-table .icon-mid {
				padding-right: 52px !important;
				padding-left: 53px !important;
			}
			.social-module .social-module-cell .icon-table img {
				height: 40px !important;
				width: 40px !important;
			}
			.footer-module .footerOptions a {
	...
	<body id="default" style="width: 100%; -webkit-appearance: none; -webkit-font-smoothing: antialiased; font-smooth: always; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; text-size-adjust: 100%; margin: 0; padding: 0;" cz-shortcut-listen="true">
		<!-- start of #background -->

		<img border='0' src="<?=url('')?>/track/{{$invoice_data->invoice_url}}"; width='1' height='1'>
						...
						<tbody><tr>
							<td valign="middle" align="center" class="hero-row" style="font-family: Helvetica, Arial, Sans-Serif;">
								<a href="#">
									...
									<img  alt="" width="200" class="img-flex" style="display: block; margin-top:40px;" data-src-retina="" data-src="<?=url('')?>/profile/{{$profile_info->image}}" src="<?=url('')?>/profile/{{$profile_info->image}}">
									@endif  </a>
							</td>
							</tr>
							<!-- /LOGO -->
							<tr>
								<td valign="top" class="hr-bot" style="font-family: Helvetica, Arial, Sans-Serif; border-bottom-width: 1px; border-bottom-color: #F1F3F4; border-bottom-style: solid;">
									<table width="100%" style="-premailer-border: 0; -premailer-cellpadding: 0; -premailer-cellspacing: 0; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border: none;" cellpadding="0" cellspacing="0">
										<tbody><tr>
											<td class="h1 h1-light-padding" align="center" style="font-family: &#39;Montserrat&#39;, sans-serif; color: #1EB343; font-size: 28px; line-height: 36px; font-weight: bold; padding: 18px 55px;text-transform:uppercase;"> Receipt for Invoice #{{$invoice_data->invoice_number}} </td>
											</tr>
											<tr>
									...
									<div class="table-responsive">
										<table class="table m-t-50">
											...
											<tbody>
												...
												<tr>
													<td class="text-center">{{$value->item}}
													</td>
									...
									<div class="container-sm-height">
										<div class="row row-sm-height b-a b-grey">
											<div class="col-sm-4 col-sm-height col-middle p-l-25 sm-p-t-15 sm-p-l-15 clearfix sm-p-b-15">
												<h5 class="font-montserrat all-caps small no-margin hint-text text-left">Sub-Total</h5>
												<h3 class="no-margin text-left">${{number_format($total,2)}}</h3>
											</div>
											<div class="col-sm-8 col-sm-height col-middle clearfix sm-p-b-15">
												<h5 class="font-montserrat all-caps small no-margin hint-text ">Discount ($)</h5>
												<h3 class="no-margin">${{number_format($total-$invoice_data->total_amount,2)}}</h3>
											</div>
											<div class="col-sm-12 text-right bg-menu col-sm-height padding-15">
												<h5 class="font-montserrat all-caps small no-margin hint-text text-white ">Total Paid</h5>
												<h1 class="no-margin text-white">${{number_format($invoice_data->total_amount,2)}}</h1>
											</div>
										</div>
									</div>
								</td>
									...
									<table width="100%" class="footer-module" align="center" style="-premailer-border: 0; -premailer-cellpadding: 0; -premailer-cellspacing: 0; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #A8BAC3; border: none;"
										...
										<tr>
											<td class="corpAddressCont" style="font-family: Helvetica, Arial, Sans-Serif; font-size: 12px; text-align: center; line-height: 18px !important; padding: 7px 0 31px;" align="center">
												This email has been sent to you by Invoyce on behalf of {{$profile_info->company}}</td>
										</tr>
										<tr>
											<td class="footerOptions" style="font-family: Helvetica, Arial, Sans-Serif; font-size: 12px; text-align: center;" align="center">
												...
												<a href="<?=url('')?>/pay/{{$invoice_data->invoice_url}}"  style="color: #A8BAC3; text-decoration: none; letter-spacing: 1px; font-weight: bold; text-transform: uppercase; border-bottom-width: 1px; border-bottom-color: #A8BAC3; border-bottom-style: solid; font-size: 10px; line-height: 22px;"><strong><b>View in browser</b></strong></a>
											</td>
										</tr>
									</table>
								</td>
